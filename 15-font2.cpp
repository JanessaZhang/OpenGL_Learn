...
void RenderText(shader &mshader, std::string text, float x, float y, float scale, glm::vec3 color);
...
int main() {
...

    {
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			RenderText(ashader, "This is sample text", 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f));
			RenderText(ashader, "(C) LearnOpenGL.com", 100.0f, 100.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));
			RenderText(ashader, "test for opengl font", 200.0f, 200.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));
...
void RenderText(shader &mshader, std::string text, float x, float y, float scale, glm::vec3 color)
{
    ...
    mshader.Bind();
    glUniform3f(glGetUniformLocation(mshader.m_RendererID, "textColor"), color.x, color.y, color.z);
